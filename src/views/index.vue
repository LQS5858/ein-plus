<template>
  ...
  <div class="contentBox">
    ...
    <h3>一套基于element-plus(依赖element-plus)适合开发者使用的轻量级公司业务UI组件库，完美支持vue3</h3>
    <div class="tiBox">
      <p>
      ...
      <div class="buttonGroups">
        ...
        <!-- <ein-button round
                  ...
                  @click="goGuthub">Github</ein-button> -->
      </div>
      <div class="cardBox">
        <li>
          <p>更小的体积</p>
      ...
      <div class="links">
        ...
        <!-- <li v-for="(item, index) in devoteList"
            :key="index"
...
const verSion = () => {
  router.push('/einyun-ui/updatelog')
}
