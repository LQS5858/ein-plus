  ...
  <div class="tabs_header "
    ...
    <div class="tabs_nav_scroll"
      ...
      <div class="tabs_nav"
        ...
        <component :is="getLabelNode(pane)"
                   v-resize="upDateBar"
...
function getLabelNode(pane) {
  const close_btn = h('i', {
    ...
    style: {
      display:
        props.type === 'line' || props.type === '' || pane.active
          ? 'inline-block'
          : '',
    },
    onClick: (event) => {
      ...
      return h(
        'div',
        {
          class: {
            ...
            'is-closable':
              pane.active || pane.props.disabled
                ? ''
                : pane.props.closable || tabsContext.props.closable
                ? true
                : false,
          },
